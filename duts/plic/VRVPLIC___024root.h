...
class VRVPLIC___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __VinpClk__TOP____Vcellinp__RVPLIC__reset;
        CData/*0:0*/ __Vclklast__TOP____Vcellinp__RVPLIC__clk;
        CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP____Vcellinp__RVPLIC__reset;
        CData/*0:0*/ __Vchglast__TOP____Vcellinp__RVPLIC__reset;
    ...
    // CONSTRUCTORS
    VRVPLIC___024root(VRVPLIC__Syms* symsp, const char* name);
    ~VRVPLIC___024root();
