...
QData VRVPLIC___024root___change_request(VRVPLIC___024root* vlSelf);
#ifdef VL_DEBUG
void VRVPLIC___024root___eval_debug_assertions(VRVPLIC___024root* vlSelf);
#endif  // VL_DEBUG
void VRVPLIC___024root___final(VRVPLIC___024root* vlSelf);

static void _eval_initial_loop(VRVPLIC__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            Verilated::debug(1);
            __Vchange = VRVPLIC___024root___change_request(&(vlSymsp->TOP));
            Verilated::debug(__Vsaved_debug);
            VL_FATAL_MT("RVPLIC.v", 7, "",
...
VL_ATTR_COLD void VRVPLIC::final() {
    VRVPLIC___024root___final(&(vlSymsp->TOP));
}
